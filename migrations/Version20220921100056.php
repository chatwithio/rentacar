 ...
 */
final class Version20220921100056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ALTER matricula TYPE VARCHAR(10)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ALTER matricula TYPE VARCHAR(15)');
